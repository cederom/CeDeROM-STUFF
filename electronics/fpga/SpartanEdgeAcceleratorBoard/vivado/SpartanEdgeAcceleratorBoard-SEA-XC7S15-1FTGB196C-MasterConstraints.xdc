...
set_propetry -dict {PACKAGE_PIN G1  IOSTANDARD TMDS_33} [get_ports FPGA_HDMI_TD0P]
...
set_propetry -dict {PACKAGE_PIN P12 IOSTANDARD LVCMOS33} [get_ports FPGA_ESP_SCL]
